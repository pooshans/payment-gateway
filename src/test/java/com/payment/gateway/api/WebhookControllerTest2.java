...
public class WebhookControllerTest2 {
    ...
    public void testHandleAuthorizeNetWebhook_Success() throws Exception {
        ...
        when(objectMapper.readValue(anyString(), eq(AuthorizeNetWebhookRequest.class))).thenReturn(webhookRequest);
        ...
        when(webhookService.processAuthorizeNetWebhook(any(AuthorizeNetWebhookRequest.class), anyString(), anyString()))
    ...
    public void testHandleAuthorizeNetWebhook_InvalidPayload() throws Exception {
        ...
        when(objectMapper.readValue(anyString(), eq(AuthorizeNetWebhookRequest.class)))
